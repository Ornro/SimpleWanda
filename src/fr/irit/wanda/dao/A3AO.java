...
public class A3AO extends DAO {
	 ...
	 */
	public int addA3(A3 a) throws AlreadyRegistredException {
	...
	public boolean exists(int id) {
		set("SELECT certificate FROM a3 WHERE certificat=?;");
		setInt(1, id);
		return executeQuery();
	}
	 ...
	 */
	public A3 getA3(int id) throws NotFoundInDatabaseException {
		set("SELECT * FROM a3 WHERE certificate=?;");
		setInt(1, id);
		executeQuery();
		A3 a = extract();
		if (a == null)
	 ...
	 */
	public Collection<A3> getAllA3() throws NotFoundInDatabaseException {
	 ...
	 */
	public A3 getA3(A3 a3) throws NotFoundInDatabaseException {
		A3 a = getA3(a3.getId());
		return a;
	}
	 ...
	 */
	public A3 getA3(String name) throws NotFoundInDatabaseException {
